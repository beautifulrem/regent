...
const en = {
  ...
  oneShotMechGas: 'gas · paid by 1Shot (ETH)',
  oneShotMechNote: 'The agent pays every fee in USDC and never holds ETH. 1Shot relays the vote and covers the gas.',
...
const zh: Dict = {
  ...
  oneShotMechGas: 'gas · 由 1Shot 垫付 (ETH)',
  oneShotMechNote: '代理全程用 USDC 付费、不持 ETH。1Shot 中继投票并垫付 gas。',
