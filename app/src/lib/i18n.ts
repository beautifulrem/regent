...
const en = {
  ...
  nodeTips: {
    ...
    burner: 'A throwaway EOA upgraded to a smart account via EIP-7702. It holds 0 ETH, signs the 7710 bundle, and pays every fee in USDC.',
...
const zh: Dict = {
  ...
  nodeTips: {
    ...
    burner: '一次性 EOA，经 EIP-7702 升级为智能账户。持有 0 ETH，签署 7710 bundle，所有费用都用 USDC 支付。',
